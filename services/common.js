...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "books.store.ecommerce@gmail.com",
...
exports.cookieExtractor = function (req) {
  ...
  //   token =
  // "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NmJkODAxOTAwYjc3OGFjNjE3MDQ5MCIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcxODM0Mzc3MX0.NI_myPLRoLnzHlVAPkTaamBAnsrOJCl1FoQtTUYN4As"  // console.log("this is the value of token",token);
  return token;
};
...
exports.sendMail = async function ({ to, subject, text, html} ) {
  //mail endpoint
    let info = await transporter.sendMail({
      from: '"BookStore-Ecommerce" <BookStore@ecommerce.com>', // sender address
      to,
      subject,
      text,
      html
...
exports.invoiceTemplate = function(order){
 ...
 <body style="background-color: #D2C7BA;">
   ...
   <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Thank you for choosing Book Store ! We're thrilled to confirm that your order has been successfully placed.
   </div>
   <!-- end preheader -->
